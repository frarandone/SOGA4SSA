...
y82 ~ normal(alpha +  0.5*beta +  lambda*y81, 0.5);
y83 ~ normal(alpha +  0.5*beta +  lambda*y82, 0.5);
y84 ~ normal(alpha +  0.5*beta +  lambda*y83, 0.5);
y85 ~ normal(alpha +  0.5*beta +  lambda*y84, 0.5);
y86 ~ normal(alpha +  0.5*beta +  lambda*y85, 0.5);
y87 ~ normal(alpha +  0.5*beta +  lambda*y86, 0.5);
y88 ~ normal(alpha +  0.5*beta +  lambda*y87, 0.5);
y89 ~ normal(alpha +  0.5*beta +  lambda*y88, 0.5);
y90 ~ normal(alpha +  0.5*beta +  lambda*y89, 0.5);
y91 ~ normal(alpha +  0.5*beta +  lambda*y90, 0.5);
y92 ~ normal(alpha +  0.5*beta +  lambda*y91, 0.5);
y93 ~ normal(alpha +  0.5*beta +  lambda*y92, 0.5);
y94 ~ normal(alpha +  0.5*beta +  lambda*y93, 0.5);
y95 ~ normal(alpha +  0.5*beta +  lambda*y94, 0.5);
y96 ~ normal(alpha +  0.5*beta +  lambda*y95, 0.5);
}
