...
set "APP_CLASSPATH=%APP_LIB_DIR%\default.blog-0.10.jar;%APP_LIB_DIR%\java-cup-11b.jar;%APP_LIB_DIR%\org.scala-lang.scala-library-2.10.4.jar;%APP_LIB_DIR%\gov.nist.math.jama-1.0.3.jar;%APP_LIB_DIR%\com.google.code.gson.gson-2.2.4.jar;%APP_LIB_DIR%\org.apache.commons.commons-math3-3.0.jar;%APP_LIB_DIR%\de.jflex.jflex-1.6.0.jar;%APP_LIB_DIR%\org.apache.ant.ant-1.7.0.jar;%APP_LIB_DIR%\org.apache.ant.ant-launcher-1.7.0.jar"
